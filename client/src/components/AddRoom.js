...
function AddRoom() {
    ...
    function CreatePost(e){
        ...
        formData.append("upload_preset", "roombooking");

 

        axios.post("https://api.cloudinary.com/v1_1/dsfnnc0dq/image/upload", formData).then((response)=>{
            ...
            axios.post("/roompost/save", createost).then(() =>{

                swal.fire({

                    title: "Success!",

                    text: "Room Adding Success!",
            ...
            <h1 className="h3 mb-3 font-weight-normal">Add New Room</h1>
                ...
                <form className="needs-validation" onSubmit={CreatePost}>
                    ...
                    <div className="form-group" style={{marginBottom:'15px'}}>
                        ...
                        <label style={{marginBottom:'5px'}}>Room Category</label>
