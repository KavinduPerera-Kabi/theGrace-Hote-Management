            ...
            <div>
                ...
                <div className="container">
                    ...
                    <Col sm={3} style={{fontFamily:'Garamond'}}>
                        <h4><b>About KandyHills</b></h4>
                        <ui className="list-unstyled">
                        <li>About Us</li>
                        <li>Our Hotel Brands</li>
                        <li>theGRACE Centers</li>
                        <li>Residences</li>
                        <li>Contact Us</li>
                        </ui>
                    ...
                    <div className="row">
                        <center>
                    <p className="col-sm">
                        &copy;{new Date().getFullYear()} theGRACE Hotel | All rights reserved |
