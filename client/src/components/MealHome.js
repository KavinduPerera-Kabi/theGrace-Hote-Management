...
<MDBRow>
      ...
      <div style={{paddingLeft:'17px'}} className="col-sm-9 mb-2">
        <h1 style={{ color:'black', letterSpacing:'5px', fontSize:'64px'}}><b>Added<br/>Meals List</b></h1>
       ...
       <button className="btn btn-primary btn-lg rounded-pill"><a href="/addmeal" style={{textDecoration:'none',color:'white'}}>Add Meal</a></button>
    </MDBCol>
    </MDBRow>
    </div>
  )
